                        ...
                        <div class="card-body">
                            ...
                            <c:if test="${product.quantity != 0}">
                                ...
                                <c:if test="${authUser ne null}">
                                    <a class="text-secondary" href="showBuyProduct?id=${product.id}"><p class="text-success"><strong>Купить</strong></p></a>
                                </c:if>
                            </c:if>
                            <c:if test="${product.quantity == 0}">
                            ...
                            <c:if test="${topRole eq 'ADMINISTRATOR'}">
                                <a class="text-secondary" href="showEditProduct?id=${product.id}"><p class="text-success"><strong>Редактировать</strong></p></a></a>
                            </c:if>
